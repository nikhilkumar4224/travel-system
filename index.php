	  ...
	  <h3>About Us</h3>
	   ...
	   <div class="container">		  
		 <div class="col-md-4 about-grids">
			 <h4>Our Vision</h4>
			 <p>Welcome to our innovative travel management system, designed to streamline your travel experiences with seamless booking, expense management, and personalized itineraries, ensuring hassle-free journeys every step of the way</p>
		 </div>
		 <div class="col-md-4 about-grids grid2">
			 <h4>Our Mission</h4>
			 <p>Our mission is to streamline travel management, providing seamless booking experiences and cost-effective solutions for businesses of all sizes</p>
		 </div>
		 <div class="col-md-4 about-grids">
			 <h4>Safety Information</h4>
			 <p>Ensuring the safety and security of your travel data is our utmost priority, with robust encryption and stringent privacy measures in place.</p>
		 </div>
	 </div>
